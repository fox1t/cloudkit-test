...
declare module CloudKit {
  ...
  export class Container {
    ...
    discoverUserIdentities(
      userLookupInfos: Array<UserLookupInfo>,
    ): Promise<UserIdentitiesResponse, CKError>
  ...
  export class Database {
     ...
     */
    deleteRecords(
      records: Array<string> | Array<RecordToDelete>,
      options?: RecordDeleteOptions,
    ): Promise<RecordsResponse, CKError>
    ...
    fetchRecordZoneChanges(
      options: Array<RecordZoneChangesOptions>,
    ): Promise<RecordZoneChangesResponse, CKError>
     ...
     */
    fetchRecordZones(
      zones: Array<string> | Array<RecordZone>,
    ): Promise<RecordZonesResponse, CKError>
     ...
     */
    fetchRecords(
      records: Array<string> | Array<RecordLike>,
     ...
     */
    saveRecords(
      records: Array<RecordToSave> | Array<RecordToCreate> | Array<RecordLike>,
      options?: RecordSaveOptions,
    ): Promise<RecordsResponse, CKError>
  ...
  export class QueryNotification extends Notification {
     ...
     */
    readonly queryNotificationReason?:
  ...
  export class RecordsBatchBuilder {
     ...
     */
    create(
      records: Array<RecordToCreate> | Array<RecordLike>,
      options?: RecordsBatchOptions,
    ): RecordsBatchBuilder
     ...
     */
    createOrUpdate(
      records: Array<RecordToCreate> | Array<RecordToSave> | Array<RecordLike>,
      options?: RecordsBatchOptions,
    ): RecordsBatchBuilder
     ...
     */
    forceReplace(
      records: Array<RecordToForceSave>,
      options?: RecordsBatchOptions,
    ): RecordsBatchBuilder
  ...
  export interface CloudKitConfig {
     ...
     */
    containers:
      | Array<ContainerConfigLike>
      | Array<ClientContainerConfig>
      | Array<ServerContainerConfig>
  ...
  export interface ContainerConfig extends ContainerConfigLike {
     ...
     * with this container.
     *
     * Possible values are `development` and
     * `production`.
     */
  ...
  export interface Promise<TResult, TError> {
     ...
     */
    then(
      onFulfilled: (result: TResult) => any,
      onRejected?: (reason?: TError) => any,
  ...
  export interface Query {
     ...
     */
    sortBy?:
      | Array<SortDescriptorLike>
      | Array<RecordFieldSortDescriptor>
      | Array<SystemFieldSortDescriptor>
  }
